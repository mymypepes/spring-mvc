...
public class CreateUserRequest {
	...
	@Size(max = 100, message = "Độ dài của address là 100 ký tự")
	@JsonProperty("address")
	private String address;
	
	@NotBlank(message = "email không được rỗng")
	@Size(max = 100, message = "Độ dài của email là 100 ký tự")
	@JsonProperty("email")
	...
	public void validated() {
		if (StringUtils.isEmpty(this.userName)) {
			...
			throw new BadRequestException(String.valueOf(HttpStatus.BAD_REQUEST.value()), "Độ dài tối đa user_name là 50 ký tự");
			...
			throw new BadRequestException(String.valueOf(HttpStatus.BAD_REQUEST.value()), "Độ dài password phải lớn hơn 8 ký tự");
